...
# === CONFIGURATION ===
SOURCE="/opt/Homebox_AI"			# Dossier à sauvegarder
DEST="/mnt/usb-storage/Backup/Homebox_AI"       # Dossier de destination
...
send_telegram "🎉 *HomeBox_AI Backup* : La sauvegarde a été effecutée ! ✅"
